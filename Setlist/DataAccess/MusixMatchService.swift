...
class MusixMatchService {
    ...
    func search(searchText: String, completion: @escaping (_ json: Data)->()) -> () {
        let urlString = "https://api.musixmatch.com/ws/1.1/track.search&q_track_artist=" + searchText + "&page_size=20&s_artist_rating=asc&s_track_rating=asc&f_has_lyrics=1&apikey=fccc7f32e576d16171d19f5b3e705e26"
